...
def get_product_url(obj, viewname):
    ct_model = obj.__class__.meta.moduk_name
...
class LatestProductsManager:
    @staticmethod
    def get_products_for_main_products(*args, **kwargs):
...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        #     raise MaxResolutionErrorExceptions('Разрешение изображения больше максимального')
        image = self.image
        img = Image.open(image)
...
class Cart(models.Model):
    ...
    final_prise = models.DecimalField(max_digits=9, decimal_places=2, verbose_name="Общая цена")
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(max_length=255, verbose_name="Максимальный объем встроеной памяти")
